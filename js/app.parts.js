...
window.parts = [
		...
		},
		{
			...
			base_description: 'Generates Exotic Particles based on heat passing through the accelerator (maximum %ep_heat). If this part explodes it causes instant reactor meltdown. Holds a maximum of %containment heat. (It is strongly advised to supply heat directly from cells!)',
			...
			base_containment: 1000000000,
			containment_multiplier: 20000,
		...
		},
		{
			...
			base_description: 'Generates Exotic Particles based on heat passing through the accelerator (maximum %ep_heat). If this part explodes it causes instant reactor meltdown. Holds a maximum of %containment heat. Actively draws %transfer heat from the reactor at the cost of 1 power per 1 heat. (It is strongly advised to supply heat directly from cells!)',
			...
			base_cost: 100000000000000,
			base_containment: 3200000000000000000000000000000,
