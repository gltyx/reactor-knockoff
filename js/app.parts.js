...
window.parts = [
		...
		{ // make this experimental????
			...
			base_description: '%single_cell_description' + ' Produces less power closer to midnight.',
			category: 'cell',
			experimental: true,
			...
			base_power: 1e15,
			base_heat: 1e15,
			//cell_tick_upgrade_cost: 7e18,
			//cell_tick_upgrade_multiplier: 10,
			//cell_power_upgrade_cost: 7e18,
			//cell_power_upgrade_multiplier: 10,
			//cell_perpetual_upgrade_cost: 14e18
		},
